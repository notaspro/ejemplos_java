...
public class Filter implements Serializable {
	...
	public String toString() {
		switch (operator) {
		case Filter.OP_IN:
			return "`" + property + "` in (" + SearchInternalUtil.paramDisplayString(value) + ")";
		case Filter.OP_NOT_IN:
			return "`" + property + "` not in (" + SearchInternalUtil.paramDisplayString(value) + ")";
		case Filter.OP_EQUAL:
			return "`" + property + "` = " + SearchInternalUtil.paramDisplayString(value);
		...
		case Filter.OP_LESS_OR_EQUAL:
			return "`" + property + "` <= " + SearchInternalUtil.paramDisplayString(value);
		case Filter.OP_LIKE:
			return "`" + property + "` LIKE " + SearchInternalUtil.paramDisplayString(value);
		case Filter.OP_ILIKE:
			return "`" + property + "` ILIKE " + SearchInternalUtil.paramDisplayString(value);
		case Filter.OP_NULL:
		...
		default:
			return "**INVALID OPERATOR: (" + operator + ") - VALUE: " + SearchInternalUtil.paramDisplayString(value) + " **";
		}
	}
